...
app_publisher = "Aman"
app_description = "dffsdfsdfs"
app_email = "admin1@gmail.com"
app_license = "mit"
# required_apps = []
...
override_doctype_class = {
	"Customer": "custom_app.overriding.customCustomer.customCustomer"
}
...
doc_events = {
	"Item": {
		...
		# "on_cancel": "method",
		# "on_trash": "method",
		"before_save":"custom_app.custom_app.custom_methods.customItem.printData"
	}
}
...
scheduler_events = {
	...
	# ],
	"hourly": [
		"custom_app.custom_app.doctype.client_data.client_data.long_running_task"
	],
# 	"weekly": [
